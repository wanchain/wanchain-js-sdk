...
let logger = utils.getLogger('PosDelegateIn.js');

/**
 * @class
 * @augments NormalChain
 */
class PosDelegateIn extends NormalChain{
    /**
     * @constructor
    ...
    createDataCreator(){
        logger.debug("Entering PosDelegateIn::createDataCreator");
        this.retResult.code = true;
        this.retResult.result = new DelegateDataCreator(this.input, this.config);
        logger.debug("PosDelegateIn::createDataCreator is completed.");
        return this.retResult;
    }

    createDataSign(){
        logger.debug("Entering PosDelegateIn::createDataSign");
        ...
        logger.debug("PosDelegateIn::createDataSign is completed, result=", this.retResult.code);
        return this.retResult;
    }
    ...
    preSendTrans(signedData){
        ...
        logger.debug("PosDelegateIn::preSendTrans");
    ...
    transFailed(){
        ...
        logger.error("PosDelegateIn::transFailed");
    ...
    postSendTrans(resultSendTrans){
        logger.debug("Entering PosDelegateIn::postSendTrans");
        ...
        record.sentTime = cur;
        logger.debug("PosDelegateIn::postSendTrans");
        logger.debug("record is :",ccUtil.hiddenProperties(record,['x']));
        global.wanDb.updateItem(this.config.normalCollection,{hashX:record.hashX},record);

        this.retResult.code = true;
        logger.debug("PosDelegateIn::postSendTrans is completed.");
        return this.retResult;
    }
}

module.exports = PosDelegateIn;
