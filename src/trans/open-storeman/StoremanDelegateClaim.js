...
let StoremanDelegateClaimDataCreator = require('../tx-data-creator/open-storeman/StoremanDelegateClaimDataCreator');

let ccUtil = require('../../api/ccUtil');
let error  = require('../../api/error');
let utils  = require('../../util/util');

let logger = utils.getLogger('StoremanDelegateClaim.js');

/**
 * @class
 * @augments NormalChain
 */
class StoremanDelegateClaim extends NormalChain{
    /**
     * @constructor
    ...
    createDataCreator(){
        logger.debug("Entering StoremanDelegateClaim::createDataCreator");
        this.retResult.code = true;
        this.retResult.result = new StoremanDelegateClaimDataCreator(this.input, this.config);
        logger.debug("StoremanDelegateClaim::createDataCreator is completed.");
        return this.retResult;
    }

    createDataSign(){
        logger.debug("Entering StoremanDelegateClaim::createDataSign");
        ...
        logger.debug("StoremanDelegateClaim::createDataSign is completed, result=", this.retResult.code);
        return this.retResult;
    }
    ...
    transFailed(){
        ...
        logger.error("StoremanDelegateClaim::transFailed");
    ...
    postSendTrans(resultSendTrans){
        logger.debug("Entering StoremanDelegateClaim::postSendTrans");
        ...
        record.sentTime = cur;
        logger.debug("StoremanDelegateClaim::postSendTrans");
        logger.debug("record is :",ccUtil.hiddenProperties(record,['x']));
        global.wanDb.updateItem(this.config.normalCollection,{hashX:record.hashX},record);

        this.retResult.code = true;
        logger.debug("StoremanDelegateClaim::postSendTrans is completed.");
        return this.retResult;
    }
}

module.exports = StoremanDelegateClaim;
