...
let StakeUpdateDataCreator = require('../tx-data-creator/wan/StakeUpdateFeeRateDataCreator');

let ccUtil = require('../../api/ccUtil');
let error  = require('../../api/error');
let utils  = require('../../util/util');

let logger = utils.getLogger('PosStakeUpdateFeeRate.js');

/**
 * @class
 * @augments NormalChain
 */
class PosStakeUpdateFeeRate extends NormalChain{
    /**
     * @constructor
    ...
    createDataCreator(){
        logger.debug("Entering PosStakeUpdateFeeRate::createDataCreator");
        this.retResult.code = true;
        this.retResult.result = new StakeUpdateDataCreator(this.input, this.config);
        logger.debug("PosStakeUpdateFeeRate::createDataCreator is completed.");
        return this.retResult;
    }

    createDataSign(){
        logger.debug("Entering PosStakeUpdateFeeRate::createDataSign");
        ...
        logger.debug("PosStakeUpdateFeeRate::createDataSign is completed, result=", this.retResult.code);
        return this.retResult;
    }
    ...
    preSendTrans(signedData){
        let record = {
            ...
            "status"      : 'Sending',
            "annotate"    : 'StakeUpdateFeeRate'
        };

        logger.debug("PosStakeUpdateFeeRate::preSendTrans");
    ...
    transFailed(){
        ...
        logger.error("PosStakeUpdateFeeRate::transFailed");
    ...
    postSendTrans(resultSendTrans){
        logger.debug("Entering PosStakeUpdateFeeRate::postSendTrans");
        ...
        record.sentTime = cur;
        logger.debug("PosStakeUpdateFeeRate::postSendTrans");
        logger.debug("record is :",ccUtil.hiddenProperties(record,['x']));
        global.wanDb.updateItem(this.config.normalCollection,{hashX:record.hashX},record);

        this.retResult.code = true;
        logger.debug("PosStakeUpdateFeeRate::postSendTrans is completed.");
        return this.retResult;
    }
}

module.exports = PosStakeUpdateFeeRate;
