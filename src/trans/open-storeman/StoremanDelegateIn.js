...
let StoremanDelegateInDataCreator = require('../tx-data-creator/open-storeman/StoremanDelegateInDataCreator');

let ccUtil = require('../../api/ccUtil');
let error  = require('../../api/error');
let utils  = require('../../util/util');

let logger = utils.getLogger('StoremanDelegateIn.js');

/**
 * @class
 * @augments NormalChain
 */
class StoremanDelegateIn extends NormalChain{
    /**
     * @constructor
    ...
    createDataCreator(){
        logger.debug("Entering StoremanDelegateIn::createDataCreator");
        this.retResult.code = true;
        this.retResult.result = new StoremanDelegateInDataCreator(this.input, this.config);
        logger.debug("StoremanDelegateIn::createDataCreator is completed.");
        return this.retResult;
    }

    createDataSign(){
        logger.debug("Entering StoremanDelegateIn::createDataSign");
        ...
        logger.debug("StoremanDelegateIn::createDataSign is completed, result=", this.retResult.code);
        return this.retResult;
    }
    ...
    transFailed(){
        ...
        logger.error("StoremanDelegateIn::transFailed");
    ...
    postSendTrans(resultSendTrans){
        logger.debug("Entering StoremanDelegateIn::postSendTrans");
        ...
        record.sentTime = cur;
        logger.debug("StoremanDelegateIn::postSendTrans");
        logger.debug("record is :",ccUtil.hiddenProperties(record,['x']));
        global.wanDb.updateItem(this.config.normalCollection,{hashX:record.hashX},record);

        this.retResult.code = true;
        logger.debug("StoremanDelegateIn::postSendTrans is completed.");
        return this.retResult;
    }
}

module.exports = StoremanDelegateIn;
